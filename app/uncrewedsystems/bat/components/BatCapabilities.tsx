...
export default function BatCapabilities(): JSX.Element {
  return (
  <>
      {/*
  ...
  Refined through real-world operations, T-BAT delivers intelligent autonomy, resilient performance, and adaptive design, giving mission teams the confidence to act swiftly and stay ahead in unpredictable environments.
</p>
          </div>
