        ...
        <div className="md:w-1/2 w-full flex justify-center items-center px-6 py-16 md:py-0">
          <div className="max-w-md w-full">
            ...
            <p className="text-3xl leading-snug text-black mb-12 tracking-tight">
              Wherever the situation demands swift, adaptable support, <span className="font-semibold">Dexter</span> stands ready to deploy without delay. It brings speed, clarity, and confidence to every task.
            </p>
