...
const ActionItem: React.FC<ActionItemProps> = ({ title, description }) => (
  <div>
    ...
    <div className="mt-3 pt-3 border-t border-neutral-600">
      <p className="text-xl text-neutral-300 font-light max-w-sm">
        {description}
      </p>
    </div>
  </div>
...
export default function FenixResponder2(): JSX.Element {
  ...
  return (
    <>
      ...
      <div className="font-clash-grotesk bg-black min-h-screen w-full flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
