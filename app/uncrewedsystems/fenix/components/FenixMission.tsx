  ...
  const allProfiles: ProfileCardProps[] = [
    {
      ...
      description: "Covertly monitor high-risk environments, track targets, and provide real-time intel to ground teams.",
    },
    {
      title: "Search & Rescue",
    ...
    },
    {
      ...
      description: "Identify and neutralize inverted threats, providing a clear operational picture in complex aerial engagements.",
    },
    {
      ...
      description: "Efficiently inspect vast networks, identifying potential leaks or damage with high-resolution visuals.",
    },
    {
      title: "Warehouse Management",
      imageUrl: "https://images.unsplash.com/photo-1587293852726-70cdb122c294?q=80&w=2070&auto=format&fit=crop",
      description: "Automate inventory checks, monitor stock levels, and identify misplaced items in large-scale warehouses.",
    },
    {
      ...
      description: "Provide continuous aerial surveillance of construction sites, tracking progress and ensuring security.",
      hasHighlight: true,
    },
  ];
    ...
    <>
      ...
      <div ref={scrollContainerRef} style={{ height: `${(allProfiles.length + 1) * 100}vh` }} className="relative">
        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          <main ref={horizontalTrackRef} className="font-clash-grotesk text-white h-full flex relative" style={{ width: `${(allProfiles.length + 1) * 100}vw` }}>
            ...
            <div className="w-screen h-screen flex-shrink-0 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="mt-20 text-gray-500 animate-pulse text-sm">
