...
export default function StormMission(): JSX.Element {
  ...
  return (
    <>
      ...
      */}
      ...
      `}</style>
      <section className="font-clash-grotesk bg-black text-white w-full min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
