...
export default function StormFeatures(): JSX.Element {
        ...
        <div className="md:w-1/2 w-full flex justify-center items-center px-6 py-16 md:py-0">
          <div className="max-w-md w-full">
            ...
            <p className="text-3xl leading-snug text-black mb-12 tracking-tight">
              Where control meets motion, STORM touches down with confidence. Designed for shifting decks and offshore demands, it ensures safe, precise landings when stability is hard to find.
            </p>
