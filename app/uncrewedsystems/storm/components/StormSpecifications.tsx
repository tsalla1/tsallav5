...
export default function StormSpecifications(): JSX.Element {
  // The features array has been updated with the content from your image.
  const features: FeatureProps[] = [
    {
      title: "Precision Deck Landings",
      description: "Purpose-built for maritime operations, it lands on decks in motion — bringing secure delivery and recovery to offshore missions, no matter the conditions.",
    },
    {
      title: "Compact Size",
      description: "Compact and reliable in any scenario, it's designed to be deployed with ease and confidence. Wherever the mission demands, it responds instantly, keeping you ahead when it matters most.",
    },
    {
      title: "Built for inclement weather",
      description: "Tested for extremes, it stays airborne through wind, rain, and dust — so missions succeed, even when the skies don't cooperate.",
    },
    {
      title: "Endurance without Compromise",
      description: "Built for extended operations, it stays airborne longer, covering vast areas with fewer returns — giving every mission more reach and resilience.",
    },
    {
      title: "Multi Payload Drop",
      description: "Engineered for dynamic tasks, it delivers multiple payloads with speed and precision. From supplies to sensors, every drop reaches exactly where and when it's needed.",
    },
  ];
