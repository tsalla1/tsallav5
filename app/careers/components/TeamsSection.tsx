...
export default function JobOpeningsPage() {
  ...
  const internships = [
    {
      ...
      description: "Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj  Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj Support UAV hardware development, flight testing, and component integration in agile engineering teamsghj.",
    },
    {
      title: "Communications Intern, EMEA",
      description: "Assist in internal/external communications, social media strategy, and brand alignment for Tsalla Aerospace.",
    },
    {
  ...
  return (
    <section className="w-full min-h-screen bg-black text-white py-20 font-Inter">
