      ...
      <div className="bg-black text-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="font-light text-sm font-inter text-gray-400 max-w-2xl mx-auto">Got a question, idea, or collaboration in mind? Reach out using the form below — our team will be in touch soon.</p>
          </div>

          <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div>
                <label htmlFor="fullName" className="block text-xs mb-1 uppercase tracking-wider font-sans">Full Name</label>
                <Input
                  id="fullName"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="block text-xs mb-1 uppercase tracking-wider font-sans">Email Address</label>
                  <Input
                    id="email"
                    type="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs mb-1 uppercase tracking-wider font-sans">Phone Number</label>
                  <Input
                    id="phone"
                    type="tel"
              ...
              <div>
                <label htmlFor="enquiryType" className="block text-xs mb-1 uppercase tracking-wider font-sans">Enquiry Type</label>
                <Input
                  id="enquiryType"
            ...
            <div>
              <label htmlFor="message" className="block text-xs mb-1 uppercase tracking-wider font-sans">Message</label>
              <Textarea
                id="message"
                rows={10}
          ...
          <div className="text-center mt-6 font-semibold font-inter">
            ...
            {submitted && (
              <p className="text-green-400 text-sm animate-pulse mb-2">✅ Message sent successfully!</p>
            )}
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-16 text-sm">
            <div className="bg-zinc-900 p-6 md:p-10 rounded-lg shadow-sm">
              ...
              <p className="mb-2 font-light text-sm font-inter">
                <span className="font-normal font-inter">Phone Number</span> - 095357 20540
              </p>
              <p className="font-light text-sm font-inter">
                <span className="font-normal font-inter">Email Address</span> - info@tsallaaerospace.com
              </p>
            </div>
            <div className="bg-zinc-900 p-6 md:p-10 rounded-lg shadow-sm">
